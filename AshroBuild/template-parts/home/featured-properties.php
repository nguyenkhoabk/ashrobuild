                                        ...
                                        <div class="rh_slide__container clearfix">
                                            ...
                                            <div class="span5 rh_slide__details">
                                                ...
                                                <div class="rh_prop_meta">
                                                    ...
                                                    $prop_size      = $post_meta_data[ 'REAL_HOMES_property_size' ][0]; // Property Size
                                                    ...
                                                    <?php if ( ! empty( $prop_size ) ) : ?>
                                                        <div class="rh_prop_meta__single">
                                                            <span class="icon">
                                                                <?php include( get_template_directory() . '/images/icon-area.svg' ); ?>
                                                            </span>
                                                            <p class="details">
                                                                <span class="number"> <?php esc_html_e( $prop_size, 'framework' ); ?> </span>
                                                                <?php if ( ! empty( $post_meta_data[ 'REAL_HOMES_property_size_postfix' ][0] ) ) : ?>
                                                                    <span>
                                                                        <?php esc_html_e( $post_meta_data[ 'REAL_HOMES_property_size_postfix' ][0], 'framework' ); ?>
                                                                    </span>
                                                                <?php endif; ?>
                                                            </p>
                                                            <!-- /.details Area -->
                                                    ...
                                                    <?php if ( ! empty( $prop_bedrooms ) ) : ?>
                                                        <div class="rh_prop_meta__single">
                                                            <span class="icon">
                                                                <?php include( get_template_directory() . '/images/icon-bed.svg' ); ?>
                                                            </span>
                                                            <p class="details">
                                                                <span class="number"> <?php esc_html_e( $prop_bedrooms, 'framework' ); ?> </span>
                                                                <span>
                                                    ...
                                                    <?php if ( ! empty( $prop_bathrooms ) ) : ?>
                                                        <div class="rh_prop_meta__single">
                                                            <span class="icon">
                                                                <?php include( get_template_directory() . '/images/icon-bath.svg' ); ?>
                                                            </span>
                                                            <p class="details">
                                                                <span class="number"> <?php esc_html_e( $prop_bathrooms, 'framework' ); ?> </span>
                                                                <span>
